...
namespace Owl
{
    ...
    //--
    void RelationRing::AddClass(Class* pClass)
    {
    ...
    //--
    void RelationRing::AddData(DataProperty* pProperty, const std::string& refString)
    {
    ...
    //--
    bool RelationRing::HasExtraClasses()
    {
    ...
    //--
    bool RelationRing::HasDataProperties()
    {
    ...
    //--
    bool RelationRing::HasObjectProperties()
    {
    ...
    void RelationRing::GetDataProperty(int iPosition, std::string& refPath, std::string& refType, std::string& refValue)
    {
    ...
    void RelationRing::GetObjectPropertyPathAndIdentAtom(int iPosition, 
    ...
    void RelationRing::GetObjectPropertyPathAndIdentBond(int iPosition, 
                                                            const std::string& refMoleculeId, 
                                                            std::string& refPath, 
                                                            std::string& refIdent)
    {
    ...
    void RelationRing::GetObjectPropertyPathAndIdentRing(int iPosition, 
                                                            const std::string& refMoleculeId, 
                                                            std::string& refPath, 
                                                            std::string& refIdent)
    {
    ...
    void RelationRing::GetObjectPropertyPathAndIdentMolecule(int iPosition, 
                                                                const std::string& refMoleculeId, 
                                                                std::string& refPath, 
                                                                std::string& refIdent)
    {
    ...
    void RelationRing::GetClassPath(int iPosition, std::string& refIdent)
    {
    ...
    // [rad] generate path and ident for ring
    void RelationRing::GetPathAndIdentRing(const std::string& refMoleculeId, std::string& refPath, std::string& refIdent)
    {
				
				refPath = m_vecSatisfiedClasses.front()->GetPrefix() + ":" + m_vecSatisfiedClasses.front()->GetName();

				std::stringstream ssConv;
				OpenBabel::OBRing* pRing = m_pRing;
    ...
    //--
    OpenBabel::OBRing* RelationRing::GetRing() const
    {
        return(m_pRing);
    }
